...
<div class="q"><b>The composer cannot hear the mix.</b> It answers for register crowding, which it
can reason about while writing. The spectral question — is my pad fighting my texture for one
band — is measured only after rendering, by a stage the critic never meets.</div>
